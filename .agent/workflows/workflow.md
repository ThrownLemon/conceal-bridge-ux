...
> **Purpose**: High-level overview of the development lifecycle for the Conceal Bridge project.
...
- [docs/build_guide.md](../../docs/build_guide.md) - Build and architecture guide
