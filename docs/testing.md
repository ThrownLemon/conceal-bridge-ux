...
1. **Mock backend requests** generated by [`BridgeApiService`]
2. **Inject a fake provider** implementing the methods enumerated
...
- HTTP behavior and retry/timeout guidance (for test realism)
