...
**Rule:** keep yellow accents _intentional_ (primary actions, focus rings, key highlights). Do not overuse.
...
**Rule:** reserve the yellow button style for the _primary_ action on a screen/step.
