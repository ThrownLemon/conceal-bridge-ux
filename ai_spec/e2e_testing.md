...
4. Select from/to networks and continue (button “Continue” only enabled when wallet is connected per [`HomePage`](conceal-bridge-ux/src/app/pages/home/home.page.ts:154))
...
**Polling completion**
7. Start swap, verify UI progresses to completion after mocked polling returns success (step logic in [`SwapPage`](conceal-bridge-ux/src/app/pages/swap/swap.page.ts:438))
