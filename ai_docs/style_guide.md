...
- Error/status banner UX rules (pageError vs statusMessage): [`error_handling.md`](conceal-bridge-ux/ai_docs/error_handling.md:1)
- Wallet UI patterns (connect modal, network menu) that must match styling: [`wallets.md`](conceal-bridge-ux/ai_docs/wallets.md:1)
- Security constraints affecting styling/assets/fonts (CSP, external hosts): [`security.md`](conceal-bridge-ux/ai_docs/security.md:1)
...
- Testing guidance for UI assertions (components, wallet flows): [`testing.md`](conceal-bridge-ux/ai_docs/testing.md:1)